...
├── frontend/                   # Kode sumber utama antarmuka pengguna (Web)
├── mbg_mobile/                 # Kode sumber untuk aplikasi versi mobile
├── stitch_mbg_route_optimi...  # Modul algoritma optimasi rute logistik
├── BAB3_Metodologi.md          # Dokumen Metodologi Penelitian/Sistem
├── Dokumen_Perancangan_...     # Dokumen Perancangan (Bab 2 & 3)
